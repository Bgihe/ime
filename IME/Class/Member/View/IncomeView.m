...
- (void)commonInit
{
    [[NSBundle mainBundle] loadNibNamed:@"IncomeView" owner:self options:nil];
...
-(CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    return CGSizeMake( _collectionView.frame.size.width/2-5, _collectionView.frame.size.height/5.5);
}
